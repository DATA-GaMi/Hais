...
zlibg()
{
    echo -e "\033[32m安装Zlibg ... \033[0m"
    ls /usr/share/zlib-1.2.11 > /dev/null
    if [ $? -eq 0 ]
    then
        echo -e "\033[36mZlibg Installed!! \033[1;0m"
    else
        cd /usr/share/ || return
...
sslinstall()
{
    echo -e "\033[32m安装openssl-1.1.1g... \033[0m"
    ls /usr/share/openssl-1.1.1g > /dev/null
    if [ $? -eq 0 ]
    then
        echo -e "\033[36mOpenssl Installed!! \033[1;0m"
    else
